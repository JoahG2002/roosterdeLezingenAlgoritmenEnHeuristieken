...
class Vak:
    __slots__: tuple[str, ...] = (
        ...
        "maximumaantal_studenten_werkcollege", "aantal_studenten_per_werkcollege", "aantal_studenten_per_practicum",
        "__hoorcolleges", "__werkcolleges", "__practica", "__studentnummers"
    )
