...
class Roostermaker:
    ...
    def _geneer_rooster_hillclimbing(self) -> None:
        ...
        """
        def update_activiteit_in_rooster(rooster: list[Activiteit | None], activiteit: Activiteit) -> None:
            """
        ...
        def verwissel_activiteiten(activiteit1_: Activiteit,
            ...
            update_activiteit_in_rooster(rooster, activiteit1_)
            update_activiteit_in_rooster(rooster, activiteit2_)
        ...
        def is_valide_zaalwissel(activiteit1_: Activiteit, activiteit2_: Activiteit) -> bool:
            """
        ...
        def geef_willekeurige_beweging(rooster: list[Activiteit | None]) -> Optional[tuple[Activiteit, Activiteit]]:
            """
        ...
        for lus in range(self.__aantal_lussen):
            ...
            activiteitenwissel: tuple[Activiteit, Activiteit] | None = geef_willekeurige_beweging(rooster_huidige_lus)
            ...
            if not is_valide_zaalwissel(activiteit1, activiteit2):
                continue

            verwissel_activiteiten(
