...
class Maxima:
    __slots__: tuple[str, ...] = (
        ...
        "ONGELDIG_ALGORITME", "STRAFPUNTENGRENS_VAKWISSELEN_NAAR_STUDENT"
    )
    ...
    def __init__(self) -> None:
        ...
        self.STRAFPUNTENGRENS_VAKWISSELEN_NAAR_STUDENT: Final[int] = 6000
...
class Algoritme:
    __slots__: tuple[str, ...] = ("VALIDEN", "VOOR_PLOT")

    def __init__(self) -> None:
        self.VALIDEN: Final[tuple[str, ...]] = ("hillclimber", "deterministisch", "simulatedAnnealing", "genetisch")
        self.VOOR_PLOT: Final[tuple[str, ...]] = (
            "deterministisch", "hillclimber", "simulated annealing", "genetisch", "willekeurig-ondergrens"
        )
...
class Bestandpad:
    __slots__: tuple[str, ...] = ("RESULTATEN_ALGORITMEN",)

    def __init__(self) -> None:
        self.RESULTATEN_ALGORITMEN: Final[str] = f"{os.getcwd()}/data/prestatiesAlgoritmen.csv"


class Plotgegeven:
    __slots__: tuple[str, ...] = ("KOLOMNAMEN_VOOR_PLOT",)
...
bestandpaden: Bestandpad = Bestandpad()
plotgegevens: Plotgegeven = Plotgegeven()
